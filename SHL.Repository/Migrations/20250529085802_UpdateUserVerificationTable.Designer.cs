...
namespace SHL.Repository.Migrations
{
    ...
    [Migration("20250529085802_UpdateUserVerificationTable")]
    partial class UpdateUserVerificationTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SHL.Domain.Models.Country", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SHL.Domain.Models.Lga", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SHL.Domain.Models.State", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SHL.Domain.Models.UserVerification", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<bool>("IsTokenExpired")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);
                    ...
                    b.Property<DateTime?>("PhoneVerifyDate")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("SHL.Domain.Models.Lga", b =>
                {
                    b.HasOne("SHL.Domain.Models.State", "State")
                        .WithMany("Lgas")
            ...
            modelBuilder.Entity("SHL.Domain.Models.State", b =>
                {
                    b.HasOne("SHL.Domain.Models.Country", "Country")
                        .WithMany("States")
            ...
            modelBuilder.Entity("SHL.Domain.Models.UserVerification", b =>
                {
                    b.HasOne("SHL.Domain.Models.Identity.ApplicationUser", "ApplicationUser")
                        .WithOne("UserVerification")
                        .HasForeignKey("SHL.Domain.Models.UserVerification", "ApplicationUserId")
                    ...
                    b.HasOne("SHL.Domain.Models.Lga", "Lga")
                        .WithMany("UserVerifications")
                        .HasForeignKey("lgaId");
